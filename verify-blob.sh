...
COSIGN_PASSWORD="$passwd" ${COSIGN} sign-blob --timestamp-server-url "${TIMESTAMP_SERVER_URL}" \
    --rfc3161-timestamp ${SIG_TIMESTAMP_FILE} --tlog-upload=false --key import-cosign.key README.md \
