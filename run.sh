...
echo "cosign sign:"
COSIGN_PASSWORD="$passwd" cosign sign --timestamp-server-url https://freetsa.org/tsr --upload=true --tlog-upload=false --key import-cosign.key --certificate-chain cacert.pem --cert cert.pem $IMG
